...
/**
 * Verbatim artist statement from karimboumjimar.com/about - used by AboutView
 * and the Inspector's default state. Keep these paragraphs as-is unless the
 * artist explicitly rewrites them.
 */
...
/**
 * Factual biographical paragraphs - used by BioView. CV-style: places,
 * education, practice, collective, principles. Distinct from the artist
 * statement (ABOUT_PARAGRAPHS).
 */
export const BIO_PARAGRAPHS = [
  "Karim Boumjimar (b. 1998, Málaga) is a Spanish-Moroccan artist working primarily in ceramics and drawing. He lives between Copenhagen, Stockholm, Berlin and Spain, after ten years in London.",
  "He completed a BFA at Central Saint Martins in London before moving to Copenhagen, where he received an MFA from the Royal Danish Academy of Fine Arts in 2025. He is entirely self-taught in ceramics, developed through long hours of studio labour in Copenhagen.",
  "Since 2016 he has been a member of the international performance collective Young Boy Dancing Group, with whom he has performed in Copenhagen, Berlin, Munich, Helsinki, Vilnius, Milan, Madrid and London.",
  "Boumjimar comes from a working-class background and runs the Working-Class Creative Grant - a no-strings 500 EUR award given throughout the year to a different working-class creative anywhere in the world, funded directly through his art sales.",
];
...
export const RECOGNITION = [
  { year: "2025", text: "Ulrica Hydman Vallien Foundation Grant" },
...
/** Reverse-chronological. URLs are best-effort known links. */
export const NEWS: NewsEntry[] = [
  ...
  { date: "28 March 2026", text: "Solo exhibition, Bodies Under Construction at Møstings, Frederiksberg Museum (28 March - 7 June 2026).", url: "https://frederiksbergmuseerne.dk/en/udstillinger/karim-boumjimar/" },
  ...
  { date: "23 January 2026", text: "Solo exhibition, Birds of Paradise at Viborg Kunsthal (23 January - 10 May 2026).", url: "https://artviewer.org/karim-boumjimar-at-viborg-kunsthal/" },
  { date: "18 December 2025", text: "Article in Cultbytes.", url: "https://cultbytes.com/in-stockholm-karim-boumjimars-insistence-on-mutability-is-defiant/" },
  ...
  { date: "9 October 2025", text: "Solo exhibition, Mouths, Vessels, Portals at Alice Folker Gallery (9 October - 28 November 2025).", url: "https://alicefolker.dk/artists/33-karim-boumjimar/overview/" },
  { date: "29 August 2025", text: "Solo exhibition, Pandemonium Paradiso at Overgaden Institute of Contemporary Art (29 August - 26 October 2025).", url: "https://artviewer.org/karim-boumjimar-at-o-overgaden-copenhagen/" },
  { date: "27 June 2025", text: "Article in ELLE Danmark." },
  { date: "20 June 2025", text: "Group exhibition, When Form Becomes Attitude at Robert Grunenberg, Berlin (20 June - 9 August 2025).", url: "https://robertgrunenberg.com/exhibition/when-form-becomes-attitude/" },
  { date: "17 May 2025", text: "Solo exhibition, Drawings from the Hotel at Pori Art Museum (17 May - 6 July 2025).", url: "https://www.poriartmuseum.fi/en/events/karim-boumjimar-drawings-from-the-hotel-2/" },
  ...
  { date: "28 October 2023", text: "Group exhibition, Queer Ecologies: Naturally Subversive Aberrations at Centre d'Art la Panera (28 October 2023 - 28 January 2024).", url: "https://www.artshelp.com/queer-ecologies-by-karim-boumjimar-chaotic-drawings-for-queer-rights/" },
];
