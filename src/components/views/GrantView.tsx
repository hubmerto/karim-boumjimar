    ...
    <TextView title="Working-Class Creative Grant">
      ...
      <section className="mt-10 space-y-3 border-t border-line pt-6">
        ...
        <p className="text-[14px] leading-[1.6] text-ink">
          Email{" "}
          <a href={mailto} className="underline decoration-line underline-offset-4 hover:decoration-ink">
            {GRANT_INFO.applyEmail}
          </a>{" "}
          with subject line &ldquo;{GRANT_INFO.applySubject}&rdquo;. Please include:
        </p>
